...
FUNCTION=$(aws cloudformation describe-stack-resource --stack-name $STACK --logical-resource-id br.com.ben.site.function --query 'StackResourceDetail.PhysicalResourceId' --output text)
